...
interface ComponentPropInterface {
  ...
  saveData: (data: { id: string; title: string; pageType: string; pageName: string }) => void;
}
...
export const PageDetails: React.FC<PageDetailsPropTypes> = (props) => {
  ...
  return (
    ...
    >
      <Form.Item name="title" label="Title" rules={[{ required: true, message: 'Please input the title of the page' }]}>
        <Input />
      </Form.Item>
      <Form.Item name="pageType" label="Page Type">
        <Select>
