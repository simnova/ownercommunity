...
import { ReadOnlyMemoryStore } from '../../../framework/seedwork/services-seedwork-datastore-memorydb/infrastructure/memory-store';
import { BaseDomainExecutionContext } from '../../../framework/seedwork/domain-seedwork/base-domain-execution-context';
import { CommunityRepository } from '../../../src/components/community/domain/community.repository';
import { CommunityEntityReference, CommunityProps } from '../../../src/components/domain/contexts/community/community/community';
import { EndUserRepository } from '../../../src/components/domain/contexts/users/end-user/end-user.repository';
import { EndUserEntityReference, EndUserProps } from '../../../src/components/domain/contexts/users/end-user/end-user';
import { EndUserRoleRepository } from '../../../src/components/domain/contexts/community/roles/end-user-role/end-user-role.repository';
import { EndUserRoleProps } from '../../../src/components/domain/contexts/community/roles/end-user-role/end-user-role';
import { MemberRepository } from '../../../src/components/domain/contexts/community/member/member.repository';
import { Member, MemberEntityReference, MemberProps } from '../../../src/components/domain/contexts/community/member/member';
...
import { DomainVisaImpl } from '../../../src/components/domain/domain.visa';
...
import { PropertyRepository } from '../../../src/components/domain/contexts/property/property/property.repository';
...
import { ServiceTicketV1Repository } from '../../../src/components/domain/contexts/cases/service-ticket/v1/service-ticket.repository';
import { ServiceTicketV1Props } from '../../../src/components/domain/contexts/cases/service-ticket/v1/service-ticket';
...
export class InteractWithTheDomain
  extends Ability
  implements InteractWithTheDomainAsRegisteredUser, InteractWithTheDomainAsCommunityMember, InteractWithTheDomainAsUnregisteredUser
{
  ...
  public static startup() {
    ...
    const DomainInfrastructureImplBDDInstance = new InfrastructureServicesBuilderBDD( // new DomainInfrastructureImplBDD(
      ...
      InteractWithTheDomain._cybersource
    );
    this.DomainImplBDDInstance = new DomainImplBDD(DomainInfrastructureImplBDDInstance.datastore, DomainInfrastructureImplBDDInstance.cognitiveSearch) as DomainImplBDD<
      MemorydbDatastoreImpl,
      MemoryCognitiveSearchImpl
    >;
  ...
  public static startWithEmptyDatabase() {
    InteractWithTheDomain._database = new MemorydbDatastoreImpl(new MemoryDatabase());
  }
