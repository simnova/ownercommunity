...
import { ServiceTicketData, MemberData } from "../../../external-dependencies/datastore";
import { ServiceTicketV1DomainAdapter, ServiceTicketV1Repository, CommunityConverter, PropertyConverter, MemberConverter, ServiceDomainAdapter, ServiceConverter, ServiceTicketV1Converter } from "../../../external-dependencies/domain";
import { ServiceTicketCreateInput, ServiceTicketUpdateInput, ServiceTicketDeleteInput, ServiceTicketSubmitInput, ServiceTicketAssignInput, ServiceTicketAddUpdateActivityInput, ServiceTicketChangeStatusInput } from "../../../external-dependencies/graphql-api";
