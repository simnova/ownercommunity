...
import { ViolationTicketV1EntityReference } from "./entities/violation-ticket";
...
import { EndUserRoleViolationTicketPermissionsSpec } from "../../../community/roles/end-user-role/end-user-role-violation-ticket-permissions";
