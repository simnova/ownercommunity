...
import { FacetDetail, FilterDetail, MemberPropertiesGetAllTagsDocument } from '../../../../generated';
...
export const PropertiesListSearchFilterTagsContainer: FC<PropertiesListSearchFilterTagsContainerProps> = (props) => {
  const { data: data, loading: loading, error: error } = useQuery(MemberPropertiesGetAllTagsDocument);
