...
export const buildMemoryViolationTicketV1UnitOfWork = (
  ...
  return new MemoryUnitOfWork(InProcEventBusInstance, NodeEventBusInstance, ViolationTicketV1, violationTicketV1MemoryStore, MemoryViolationTicketV1Repository);
};