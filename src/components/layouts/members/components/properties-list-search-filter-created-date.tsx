...
export const PropertiesListSearchFilterCreatedDate: React.FC<PropertiesListSearchFilterCreatedDateProps> = (props) => {
  ...
  return (
    <>
      <Collapse
        ...
        defaultActiveKey={searchParams.get(FilterNames.CreatedAt) ? FilterNames.CreatedAt : undefined}
      >
