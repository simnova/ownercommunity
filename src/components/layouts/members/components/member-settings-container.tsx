...
export type MemberSettingsContainerPropTypes = PropTypes.InferProps<typeof ComponentPropTypes> & ComponentPropInterface;

export const MemberSettingsContainer: React.FC<any> = (props) => {
  ...
  const content = () => {
    if(memberLoading ) {
      ...
      return <MemberSettings data={memberData.member.profile} onSave={handleSave} />
    } else {
