...
import { MsalProviderPopupConfig, MsalProviderRedirectConfig } from '../components/shared/msal-react-lite';
import { ConfigType, MsalProviderConfigMap } from '../components/shared/msal-react-lite/msal-provider';
...
const accountConfig: MsalProviderRedirectConfig = {
...
const msalProviderConfig: MsalProviderConfigMap = {
  type: ConfigType.Map,
