...
class MemoryServiceTicketV1ActivityDetail extends MemoryBaseAdapter implements ServiceTicketV1ActivityDetailProps {
  activityType: string;
...
class MemoryServiceTicketV1Photo extends MemoryBaseAdapter implements ServiceTicketV1PhotoProps {
  documentId: string;
  description: string;
...
class MemoryServiceTicketV1 extends MemoryBaseAdapter implements ServiceTicketV1Props  {
  ...
  get activityLog() {
    return new MemoryPropArray(this._activityLog, MemoryServiceTicketV1ActivityDetail);
  };
  private _photos: ServiceTicketV1PhotoProps[] = [];
  get photos() {
    return new MemoryPropArray(this._photos, MemoryServiceTicketV1Photo);
  };
  createdAt: Date;
  updatedAt: Date;
