...
export const LoggedIn: FC<any> = (props) => {
  ...
  let profileImage = props.data.profileImage ? <Image src={props.data.profileImage} fallback={`https://ui-avatars.com/api/?name=${props.data.firstName}+${props.data.lastName}`}/> : <></>
  return <>
    <div className='ml-3'>
