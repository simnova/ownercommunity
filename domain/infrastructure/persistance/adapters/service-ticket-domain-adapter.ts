...
export class ServiceTicketDomainAdapter extends MongooseDomainAdapter<ServiceTicket> implements ServiceTicketProps {
  constructor(props: ServiceTicket) {
    super(props);
  }
  ...
  get property() {
    if (this.props.property) {
      return new PropertyDomainAdapter(this.props.property);
    }
  }
  ...
  get requestor() {
    if (this.props.requestor) {
      return new MemberDomainAdapter(this.props.requestor);
    }
  }
  ...
  get assignedTo() {
    if (this.props.assignedTo) {
      return this.props.assignedTo ? new MemberDomainAdapter(this.props.assignedTo) : undefined;
    }
  }
  ...
  get activityLog() {
    return new MongoosePropArray(this.props.activityLog, ActivityDetailDomainAdapter);
  }

  get photos() {
    return new MongoosePropArray(this.props.photos, PhotoDomainAdapter);
  }
