...
export const buildMemoryServiceTicketV1UnitOfWork = (
  ...
  return new MemoryUnitOfWork(SyncDomainEventBusInstance, NodeEventBusInstance, ServiceTicketV1, serviceTicketV1MemoryStore, MemoryServiceTicketV1Repository);
};