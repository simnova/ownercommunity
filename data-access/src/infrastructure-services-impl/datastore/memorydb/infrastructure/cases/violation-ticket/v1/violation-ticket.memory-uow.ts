...
export const buildMemoryViolationTicketV1UnitOfWork = (
  violationTicketV1MemoryStore: MemoryStore<ViolationTicketV1Props>,
) => {
  return new MemoryUnitOfWork(SyncDomainEventBusInstance, NodeEventBusInstance, ViolationTicketV1, violationTicketV1MemoryStore, MemoryViolationTicketV1Repository);
};