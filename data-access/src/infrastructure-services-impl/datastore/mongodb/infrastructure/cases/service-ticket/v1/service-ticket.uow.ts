...
export const MongoServiceTicketV1UnitOfWork = new MongoUnitOfWork(SyncDomainEventBusInstance, NodeEventBusInstance, ServiceTicketModel, new ServiceTicketV1Converter(), MongoServiceTicketV1Repository);