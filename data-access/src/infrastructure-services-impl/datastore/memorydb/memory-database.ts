...
export interface IMemoryDatabase {
  // community
  communityUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, Community<CommunityProps>, InfrastructureContext, MemoryCommunityRepository<CommunityProps, Community<CommunityProps>>>;
  communityReadonlyMemoryStore: ReadOnlyMemoryStore<CommunityProps>;
  // communityDatastore: MemoryCommunityDatastore;
  // user
  endUserUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, EndUserVisa, EndUser<EndUserProps>, InfrastructureContext, MemoryEndUserRepository<EndUserProps, EndUser<EndUserProps>>>;
  endUserReadonlyMemoryStore: ReadOnlyMemoryStore<EndUserProps>;

  staffUserUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, StaffUserVisa, StaffUser<StaffUserProps>, InfrastructureContext, MemoryStaffUserRepository<StaffUserProps, StaffUser<StaffUserProps>>>;
  staffUserReadonlyMemoryStore: ReadOnlyMemoryStore<StaffUserProps>;
  // userDatastore: MemoryUserDatastore;
  
  // end user role
  endUserRoleUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, EndUserRole<EndUserRoleProps>, InfrastructureContext, MemoryEndUserRoleRepository<EndUserRoleProps, EndUserRole<EndUserRoleProps>>>;
  endUserRoleReadonlyMemoryStore: ReadOnlyMemoryStore<EndUserRoleProps>;

  // staff role
  staffRoleUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, StaffRole<StaffRoleProps>, InfrastructureContext, MemoryStaffRoleRepository<StaffRoleProps, StaffRole<StaffRoleProps>>>;
  staffRoleReadonlyMemoryStore: ReadOnlyMemoryStore<StaffRoleProps>;
  // roleDatastore: MemoryRoleDatastore;
  // member
  memberUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, Member<MemberProps>, InfrastructureContext, MemoryMemberRepository<MemberProps, Member<MemberProps>>>;
  memberReadonlyMemoryStore: ReadOnlyMemoryStore<MemberProps>;
  // memberDatastore: MemoryMemberDatastore;
  // property
  propertyUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, PropertyVisa, Property<PropertyProps>, InfrastructureContext, MemoryPropertyRepository<PropertyProps, Property<PropertyProps>>>;
  propertyReadonlyMemoryStore: ReadOnlyMemoryStore<PropertyProps>;
  // propertyDatastore: MemoryPropertyDatastore;
  // service
  serviceUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ServiceVisa, Service<ServiceProps>, InfrastructureContext, MemoryServiceRepository<ServiceProps, Service<ServiceProps>>>;
  serviceReadonlyMemoryStore: ReadOnlyMemoryStore<ServiceProps>;
  // serviceDatastore: MemoryServiceDatastore;
  // service-ticket
  serviceTicketV1UnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ServiceTicketV1Visa, ServiceTicketV1<ServiceTicketV1Props>, InfrastructureContext, MemoryServiceTicketV1Repository<ServiceTicketV1Props, ServiceTicketV1<ServiceTicketV1Props>>>;
  ...
  violationTicketV1UnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ViolationTicketV1Visa, ViolationTicketV1<ViolationTicketV1Props>, InfrastructureContext, MemoryViolationTicketV1Repository<ViolationTicketV1Props, ViolationTicketV1<ViolationTicketV1Props>>>;
...
export class MemoryDatabase implements IMemoryDatabase{
  ...
  // community
  private _communityUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, Community<CommunityProps>, InfrastructureContext, MemoryCommunityRepository<CommunityProps, Community<CommunityProps>>>;
  ...
  // }
  public get communityUnitOfWork():  MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, Community<CommunityProps>, InfrastructureContext, MemoryCommunityRepository<CommunityProps, Community<CommunityProps>>>{
  ...
  // user
  private _staffUserUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, StaffUserVisa, StaffUser<StaffUserProps>, InfrastructureContext, MemoryStaffUserRepository<StaffUserProps, StaffUser<StaffUserProps>>>;
  ...
  // }
  public get staffUserUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, StaffUserVisa, StaffUser<StaffUserProps>, InfrastructureContext, MemoryStaffUserRepository<StaffUserProps, StaffUser<StaffUserProps>>> {
  ...
  public get staffUserReadonlyMemoryStore(): ReadOnlyMemoryStore<StaffUserProps> {
    ...
    // user
    private _endUserUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, EndUserVisa, EndUser<EndUserProps>, InfrastructureContext, MemoryEndUserRepository<EndUserProps, EndUser<EndUserProps>>>;
    ...
    //   return new MemoryUserDatastore(readonlyMemoryStore);
    // }
    public get endUserUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, EndUserVisa, EndUser<EndUserProps>, InfrastructureContext, MemoryEndUserRepository<EndUserProps, EndUser<EndUserProps>>> {
  ...
  // end user role
  private _endUserRoleUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, EndUserRole<EndUserRoleProps>, InfrastructureContext, MemoryEndUserRoleRepository<EndUserRoleProps, EndUserRole<EndUserRoleProps>>>;
  ...
  // }
  public get endUserRoleUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, EndUserRole<EndUserRoleProps>, InfrastructureContext, MemoryEndUserRoleRepository<EndUserRoleProps, EndUserRole<EndUserRoleProps>>> {
  ...
  public get endUserRoleReadonlyMemoryStore(): ReadOnlyMemoryStore<EndUserRoleProps> {
    ...
    // staff role
    private _staffRoleUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, StaffRole<StaffRoleProps>, InfrastructureContext, MemoryStaffRoleRepository<StaffRoleProps, StaffRole<StaffRoleProps>>>;
    ...
    //   return new MemoryRoleDatastore(readonlyMemoryStore);
    // }
    public get staffRoleUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, StaffRole<StaffRoleProps>, InfrastructureContext, MemoryStaffRoleRepository<StaffRoleProps, StaffRole<StaffRoleProps>>> {
  ...
  // member
  private _memberUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, Member<MemberProps>, InfrastructureContext, MemoryMemberRepository<MemberProps, Member<MemberProps>>>;
  ...
  // }
  public get memberUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, CommunityVisa, Member<MemberProps>, InfrastructureContext, MemoryMemberRepository<MemberProps, Member<MemberProps>>> {
  ...
  // property
  private _propertyUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, PropertyVisa, Property<PropertyProps>, InfrastructureContext, MemoryPropertyRepository<PropertyProps, Property<PropertyProps>>>;
  ...
  // }
  public get propertyUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, PropertyVisa, Property<PropertyProps>, InfrastructureContext, MemoryPropertyRepository<PropertyProps, Property<PropertyProps>>> {
  ...
  // service
  private _serviceUnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ServiceVisa, Service<ServiceProps>, InfrastructureContext, MemoryServiceRepository<ServiceProps, Service<ServiceProps>>>;
  ...
  // }
  public get serviceUnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ServiceVisa, Service<ServiceProps>, InfrastructureContext, MemoryServiceRepository<ServiceProps, Service<ServiceProps>>> {
  ...
  // service-ticket
  private _serviceTicketV1UnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ServiceTicketV1Visa, ServiceTicketV1<ServiceTicketV1Props>, InfrastructureContext, MemoryServiceTicketV1Repository<ServiceTicketV1Props, ServiceTicketV1<ServiceTicketV1Props>>>;
  ...
  // }
  public get serviceTicketV1UnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ServiceTicketV1Visa, ServiceTicketV1<ServiceTicketV1Props>, InfrastructureContext, MemoryServiceTicketV1Repository<ServiceTicketV1Props, ServiceTicketV1<ServiceTicketV1Props>>> {
  ...
  // violation-ticket
  private _violationTicketV1UnitOfWork: MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ViolationTicketV1Visa, ViolationTicketV1<ViolationTicketV1Props>, InfrastructureContext, MemoryViolationTicketV1Repository<ViolationTicketV1Props, ViolationTicketV1<ViolationTicketV1Props>>>;
  ...
  //   return new MemoryServiceTicketDatastore(JSON.parse(JSON.stringify(readonlyMemoryStore))); // [MG-TBD] - fix this temp workaround
  // }
  public get violationTicketV1UnitOfWork(): MemoryUnitOfWork<BaseDomainExecutionContext, DomainEntityProps, ViolationTicketV1Visa, ViolationTicketV1<ViolationTicketV1Props>, InfrastructureContext, MemoryViolationTicketV1Repository<ViolationTicketV1Props, ViolationTicketV1<ViolationTicketV1Props>>> {
