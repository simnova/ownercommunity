...
import { EndUserRolePropertyPermissionsSpec } from '../../community/roles/end-user-role/end-user-role-property-permissions';
import { PropertyEntityReference } from './entities/property';
