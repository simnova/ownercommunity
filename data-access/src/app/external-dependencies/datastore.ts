...
export { Role as RoleData, RoleModel, CommunityPermissions, PropertyPermissions, ServicePermissions, ServiceTicketPermissions, ViolationTicketPermissions } from "../../infrastructure-services-impl/datastore/mongodb/models/role";
