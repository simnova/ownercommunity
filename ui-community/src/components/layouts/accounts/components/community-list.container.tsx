...
import { Community, CommunityListContainerCommunitiesQueryDocument, CommunityListContainerMembersByUserExternalIdQueryDocument, Member } from '../../../../generated';
import { CommunityList } from './community-list';
import { ComponentQueryLoader } from '../../../ui/molecules/component-query-loader';
import { jwtDecode } from 'jwt-decode';

export const CommunityListContainer: React.FC<any> = () => {
  const { loading: communityLoading, error: communityError, data: communityData } = useQuery(CommunityListContainerCommunitiesQueryDocument);
