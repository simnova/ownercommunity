...
export const PropertiesListSearchFilterUpdatedDate: React.FC<PropertiesListSearchFilterUpdatedDateProps> = (props) => {
  ...
  return (
    <>
      <Collapse
        ...
        defaultActiveKey={searchParams.get(FilterNames.UpdatedAt) ? FilterNames.UpdatedAt : undefined}
      >
