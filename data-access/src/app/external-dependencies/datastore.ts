...
export { Role as RoleData, RoleModel, CommunityPermissions, PropertyPermissions, ServicePermissions, ServiceTicketPermissions, ViolationTicketPermissions, Permissions } from "../../infrastructure-services-impl/datastore/mongodb/models/role";
...
export { ViolationTicket as ViolationTicketData, ViolationTicketModel } from "../../infrastructure-services-impl/datastore/mongodb/models/violation-ticket";