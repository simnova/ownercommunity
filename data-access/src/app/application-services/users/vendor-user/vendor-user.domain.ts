...
export interface VendorUserDomainApi {
  ...
  updateUser(user: UserUpdateInput) : Promise<VendorUserData>; 
}
type PropType = VendorUserDomainAdapter;
type DomainType = VendorUser<PropType>;
type RepoType = VendorUserRepository<PropType>;

export class VendorUserDomainApiImpl
  extends DomainDataSource<AppContext, VendorUserData, PropType, VendorUserVisa, DomainType, RepoType>
  implements VendorUserDomainApi {

  async updateUser(user: UserUpdateInput): Promise<VendorUserData> {
