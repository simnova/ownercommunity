...
export interface ViolationTicketV1UnitOfWork extends UnitOfWork<DomainExecutionContext, ViolationTicketV1Props, ViolationTicketV1Visa, ViolationTicketV1<ViolationTicketV1Props>, ViolationTicketV1Repository<ViolationTicketV1Props>> {
}
