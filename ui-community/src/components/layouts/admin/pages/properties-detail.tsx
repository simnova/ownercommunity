...
export const PropertiesDetail: React.FC<any> = () => {
  ...
  const pages = [
    ...
    { id: '2', path: useResolvedPath('listing').pathname, title: 'Listing', icon: <FileOutlined /> },
    { id: '3', path: useResolvedPath('location').pathname, title: 'Location', icon: <CompassOutlined /> }
  ];
