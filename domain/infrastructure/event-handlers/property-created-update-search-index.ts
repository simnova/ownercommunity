...
export default () => { NodeEventBus.register(PropertyCreatedEvent, async (payload) => {
  console.log(`Property Created - Search Index Integration: ${JSON.stringify(payload)} and PropertyId: ${payload.id}`);
