...
import { Button, Input, TreeSelect,notification } from "antd";
...
export const EditorDetail = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-slate-500 items-center flex flex-col ">
        <div key={selectedPage.toString()} className={"grow overflow-y-auto transition-[max-width] transition-[min-width] ease-in-out duration-150 " + (mobileView ? " max-w-[375px] max-h-[667px] min-w-[375px] " : "max-w-[100%] max-h-[100%] min-w-[100%]")}>
