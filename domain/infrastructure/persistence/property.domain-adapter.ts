...
export class PropertyDomainAdapter extends MongooseDomainAdapter<Property> implements PropertyProps {
  ...
  get propertyName() {return this.doc.propertyName;}
  set propertyName(propertyName) {this.doc.propertyName = propertyName;}

  get propertyType() {return this.doc.propertyType;}
  set propertyType(propertyType) {this.doc.propertyType = propertyType;}

  get listedForSale() {return this.doc.listedForSale;}
  set listedForSale(listedForSale) {this.doc.listedForSale = listedForSale;}

  get listedForRent() {return this.doc.listedForRent;}
  set listedForRent(listedForRent) {this.doc.listedForRent = listedForRent;}

  get listedForLease() {return this.doc.listedForLease;}
  set listedForLease(listedForLease) {this.doc.listedForLease = listedForLease;}
  ...
  set tags(tags) {this.doc.tags = tags;}

  get hash() {return this.doc.hash;}
  set hash(hash) {this.doc.hash = hash;}

  get lastIndexed() {return this.doc.lastIndexed;}
  set lastIndexed(lastIndexed) {this.doc.lastIndexed = lastIndexed;}
