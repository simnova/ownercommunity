export interface SendReportCaseV1MessageProps extends DomainEntityProps {
  // Primitive Fields
  sentBy: string;
  message: string;
  embedding?: string;
...
export interface SendReportCaseV1MessageEntityReference extends Readonly<Omit<SendReportCaseV1MessageProps, 'initiatedBy' | 'setInitiatedByRef'>> {
...
export class SendReportCaseV1Message extends DomainEntity<SendReportCaseV1MessageProps> implements SendReportCaseV1MessageEntityReference {
  constructor(props: SendReportCaseV1MessageProps, private readonly context: DomainExecutionContext /*, private readonly visa: CommunityVisa */) {
    super(props);
  }
  ...
  private validateVisa() {
    ...
    //     (permissions) => permissions.isSystemAccount || permissions.canManageMembers || (permissions.canEditOwnSendReportCaseV1Messages && permissions.isEditingOwnSendReportCaseV1Message)
    //   )
    // ) {
